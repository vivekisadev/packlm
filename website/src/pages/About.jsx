  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '120px 2rem', minHeight: '80vh' }}>
      ...
      <div style={{ marginBottom: '80px' }}>
        ...
        <p style={{ fontSize: '20px', color: 'var(--muted)', lineHeight: '1.6', maxWidth: '600px' }}>
      ...
      <div style={{ marginBottom: '100px' }}>
        ...
        <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
          ...
          <a href="https://twitter.com/vivekisadev" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', fontSize: '14px', color: '#1DA1F2', border: '1px solid rgba(29, 161, 242, 0.3)', padding: '10px 20px', borderRadius: '40px', textDecoration: 'none', transition: 'all 0.2s' }} onMouseOver={(e) => { e.currentTarget.style.borderColor = 'rgba(29, 161, 242, 0.8)'; e.currentTarget.style.background = 'rgba(29, 161, 242, 0.05)' }} onMouseOut={(e) => { e.currentTarget.style.borderColor = 'rgba(29, 161, 242, 0.3)'; e.currentTarget.style.background = 'transparent' }}>
